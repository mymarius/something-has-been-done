...
if(miktar > para) return message.channel.send(new Discord.MessageEmbed()
                                        .setColor("RED")
                                        .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
                                        .setDescription(`Slots oynamak için cüzdanında ${para ? "sadece " + para + ' Rovcoin <a:rovcoin:972225897409155142> var!' : 'hiç rovcoinin yok!'}`))

if(miktar < 100) return message.channel.send(new Discord.MessageEmbed()
      .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
      .setColor("GREEN")
      .setDescription(`**Slot-Machine** oynamak için en az 100 Rovcoin <a:rovcoin:972225897409155142> yatırabilirsin!`))
...
.setDescription(`🤔 Girdiğin miktar geçerli bir sayı değil !?`))
 ...
 .setDescription(`**${kazandin} <a:rovcoin:972225897409155142> kazandın!**
